...
export const PacienteCard: React.FC<PacienteCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-card border border-gray-200 overflow-hidden max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className={`px-2 py-0.5 rounded-full border ${getSexoColor(paciente.sexo)} text-2xs font-medium flex items-center gap-1 bg-white`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-warning hover:text-white text-gray-700 border-2 border-gray-200 hover:border-warning rounded-lg transition-all duration-200 text-xs font-semibold shadow-sm hover:shadow-warning group"
            >
              <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-info hover:text-white text-gray-700 border-2 border-gray-200 hover:border-info rounded-lg transition-all duration-200 text-xs font-semibold shadow-sm hover:shadow-info group"
            >
              <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-6 py-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="space-y-4">
            ...
            {paciente.telefono && (
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-2xs text-gray-500 font-medium mb-0.5">Teléfono</p>
                  <p className="text-sm text-gray-900 font-semibold truncate">{paciente.telefono}</p>
                </div>
              </div>
            )}
            ...
            {paciente.email && (
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-2xs text-gray-500 font-medium mb-0.5">Email</p>
                  <p className="text-sm text-gray-900 font-semibold truncate">{paciente.email}</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            {paciente.direccion && (
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-2xs text-gray-500 font-medium mb-1">Dirección</p>
                <p className="text-sm text-gray-900 font-medium">{paciente.direccion}</p>
              </div>
            )}
            
            {paciente.idCiudad && (
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-2xs text-gray-500 font-medium mb-1">Ciudad</p>
                <p className="text-sm text-gray-900 font-medium">{paciente.idCiudad}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-2xs text-gray-500 font-medium mb-1">Fecha de Nacimiento</p>
              <p className="text-sm text-gray-900 font-medium">{paciente.fechaNac}</p>
            </div>
            
            {paciente.eps && (
              <div className="p-3 bg-gradient-to-br from-success-light to-white rounded-lg border border-success-clarity">
                <div className="flex items-center gap-2 mb-1">
                  <svg className="w-4 h-4 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                ...
                <p className="text-sm text-gray-900 font-bold">{paciente.eps}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-600">Paciente registrado</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="text-xs text-gray-600">Última actualización: Hoy</span>
            </div>
          </div>
