...
export const HistoriaCard: React.FC<HistoriaCardProps> = (props) => {
  ...
  const renderDiagnostico = () => {
    ...
    return (
      <p className="p-4 text-gray-900 border rounded-lg text-2sm dark:text-gray-100 bg-info-light dark:bg-info-clarity border-info-clarity">
  ...
  const renderTratamiento = () => {
      ...
      return (
        <div className="flex flex-col gap-2">
          {historia.tratamiento.map((trat, idx) => (
            <div
              key={idx}
              className="flex flex-col gap-1 px-3 py-2 text-xs font-medium border rounded-lg shadow-sm bg-light dark:bg-coal-400 border-success-light text-success md:flex-row md:items-center"
            >
    ...
    return (
      <p className="p-4 text-gray-900 border rounded-lg text-2sm dark:text-gray-100 bg-success-light dark:bg-success-clarity border-success-clarity">
  ...
  return (
    <div className="overflow-hidden border border-gray-200 card bg-light dark:bg-coal-300 shadow-card dark:border-gray-700 rounded-xl">
      ...
      <div className="px-7.5 py-6 space-y-6">
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <h4 className="flex items-center gap-2 mb-2 font-semibold text-gray-700 text-2sm dark:text-gray-200">
              <span className="w-1 h-4 rounded-full bg-primary"></span>
              Motivo de Consulta
            </h4>
            <p className="p-4 text-gray-900 border border-gray-200 rounded-lg text-2sm dark:text-gray-100 bg-light-active dark:bg-coal-400 dark:border-gray-700">
          ...
          <div>
            ...
            <div className="p-4 space-y-1 text-gray-900 border border-gray-200 rounded-lg text-2sm dark:text-gray-100 bg-light-active dark:bg-coal-400 dark:border-gray-700">
          ...
          <div>
            <h4 className="flex items-center gap-2 mb-3 font-semibold text-gray-700 text-2sm dark:text-gray-200">
              <span className="w-1 h-4 rounded-full bg-info"></span>
              Diagnóstico
            ...
            <div className="p-4 border rounded-lg bg-info-light dark:bg-info-clarity border-info-clarity">
              {renderDiagnostico()}
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="p-4 border rounded-lg bg-success-light dark:bg-success-clarity border-success-clarity">
              {renderTratamiento()}
            </div>
          </div>
          ...
          {historia.observaciones && (
            <div className="lg:col-span-2">
              ...
              <p className="p-4 text-gray-900 border rounded-lg text-2sm dark:text-gray-100 bg-warning-light dark:bg-warning-clarity border-warning-clarity">
                {historia.observaciones}
              </p>
            </div>
          )}
