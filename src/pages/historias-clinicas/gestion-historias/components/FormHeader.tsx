...
export const FormHeader: React.FC<FormHeaderProps> = ({ isEdit, tipo }) => {
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-primary-light via-transparent to-transparent opacity-60 dark:from-coal-400 dark:opacity-30"></div>
      <div className="relative px-7.5 py-5 border-b border-gray-200 dark:border-gray-700 bg-light dark:bg-coal-300">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-primary to-primary-active rounded-xl flex items-center justify-center shadow-primary flex-shrink-0">
              <svg className="w-6 h-6 text-primary-inverse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-2sm text-gray-600 dark:text-gray-400">
