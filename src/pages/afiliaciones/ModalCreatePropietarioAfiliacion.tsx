...
const ModalCreatePropietarioAfiliacion = ({ open, onClose, afiliacion, onSave, totalPorcentaje, vehiculo }: ModalProps) => {
  ...
  return (
   ...
   <div>
                <label className="block text-sm font-medium mb-2">Celular Adicional (Opcional)</label>
                <input
                  type="text"
                  name="celularExtra"
                  placeholder="Ingrese el celular"
                ...
                />
                {errors.celularExtra && <p className="text-red-500 text-sm mt-1">{errors.celularExtra}</p>}
              </div>

              <div>
                <label className="block text-sm font-medium mb-2">Correo Adicional (Opcional)</label>
                <input
                  type="text"
                  name="emailExtra"
                ...
                />
                {errors.emailExtra && <p className="text-red-500 text-sm mt-1">{errors.emailExtra}</p>}
              </div>
                  ...
                  {!selectedFilesVehiculo[documento.tipoDocumento.id]?.file ? (
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <label className="block text-sm font-medium">
                        Fecha de vigencia - {documento.tipoDocumento.tituloDocumento} *
                      </label>
                      <input
                        type="date"
                        value={selectedFilesVehiculo[documento.tipoDocumento.id]?.fechaExpedicion || ''}
