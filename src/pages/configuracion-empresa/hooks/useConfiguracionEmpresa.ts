...
if (!id) return;        setPageLoading(true);
    ...
    return {
        ...
        // Setters
        setPageLoading, setFormData, setLogoPreview, setPortadaPreview, setLogoFile, setPortadaFile,
        setWompiKeys, setBanners, setShowBannerModal, setBannerToEdit, setShowFacturacionModal,
        
        // Handlers y funciones de lógica
        fetchWompiConfig, handleWompiKeysSubmit, updateFacturacionElectronica, confirmFacturacionChange,
        handleChange, handleWompiKeysChange, fetchBanners, openModalBanner, resetBannerModal,
        guardarBanner, eliminarBanner, handleFileChange, handleSubmit
    };
};