  ...
  const renderContent = () => {
    return (
      <div
        ...
        className={clsx(
          'sidebar lg:fixed lg:z-20 lg:top-0 lg:bottom-0 lg:start-0 lg:translate-x-0 flex flex-col items-stretch shrink-0 bg-light dark:bg-transparent lg:border-r lg:border-gray-200 lg:dark:border-white/5',
          themeClass
        )}
      >
