                ...
                <div className="flex space-x-3">
                    ...
                    {prestadores.length === 0 && !cargandoPrestadores && (
                        <p className="text-xs font-medium text-red-600">
                            ⚠️ Debe agregar al menos un Prestador para crear reservas.
                        </p>
                    )}
                </div>
            ...
            {vista === 'semanal' && (
                <div className="flex justify-center mb-4 space-x-4">
                    <button
                        ...
                        className={`px-3 py-1 rounded-lg transition-colors text-sm ${indiceSemana === 0
                    ...
                    <button
                        ...
                        className={`px-3 py-1 rounded-lg transition-colors text-sm ${indiceSemana + 1 >= totalSemanas
                                ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                : 'bg-indigo-100 text-blue-400 hover:bg-indigo-200'
                            }`}
                    >
