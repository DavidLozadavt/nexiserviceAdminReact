              ...
              <div className="grid gap-5 lg:gap-7.5">
                ...
                <div className="card">
                  ...
                  <div className="card-body pt-2 pb-3 flex justify-center">
                    <button onClick={()=> setIsObservacionPreocupacionalOpen(true)} className="w-full flex items-center justify-center btn-light  px-4 py-2 btn btn-sm rounded">
