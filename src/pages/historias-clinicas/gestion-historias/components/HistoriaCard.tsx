...
export const HistoriaCard: React.FC<HistoriaCardProps> = (props) => {
  ...
  const renderDiagnostico = () => {
            ...
            {historia.diagnosticos.map((diag: any, idx) => {
              ...
              if (typeof diag === 'object' && diag !== null && diag.cie_id) {
                ...
                return (
                  <span 
                    key={idx} 
                    className="inline-flex items-center gap-1.5 bg-light dark:bg-coal-400 border border-info-light text-info rounded-lg px-3 py-1.5 text-xs font-medium shadow-sm"
                  >
                    <span className="text-gray-800 dark:text-gray-100">{cie ? `${cie.codigo} - ${cie.descripcion}` : diag.cie_id}</span>
                  </span>
                );
              }
              ...
              if (typeof diag === 'number') {
                return (
                  <span key={idx} className="inline-flex items-center gap-1.5 bg-light dark:bg-coal-400 border border-info-light text-info rounded-lg px-3 py-1.5 text-xs font-medium shadow-sm">
                    <span className="text-gray-800 dark:text-gray-100">{diag}</span>
                  </span>
                );
              }
              ...
              if (typeof diag === 'object' && diag !== null && diag.codigo && diag.descripcion) {
                return (
                  <span 
                    ...
                    className="inline-flex items-center gap-1.5 bg-light dark:bg-coal-400 border border-info-light text-info rounded-lg px-3 py-1.5 text-xs font-medium shadow-sm"
                  >
                    <span className="text-gray-800 dark:text-gray-100">{diag.codigo} - {diag.descripcion}</span>
                  </span>
                );
              }
              ...
              if (typeof diag === 'string') {
                ...
                return (
                  <span key={idx} className="inline-flex items-center gap-1.5 bg-light dark:bg-coal-400 border border-info-light text-info rounded-lg px-3 py-1.5 text-xs font-medium shadow-sm">
                    <span className="text-gray-800 dark:text-gray-100">{cie ? `${cie.codigo} - ${cie.descripcion}` : diag}</span>
                  </span>
                );
              }
              // Fallback
    ...
    return (
      <p className="text-2sm text-gray-900 dark:text-gray-100 bg-info-light dark:bg-info-clarity p-4 rounded-lg border border-info-clarity">
  ...
  const renderTratamiento = () => {
      ...
      return (
        <div className="flex flex-col gap-2">
          {historia.tratamiento.map((trat, idx) => (
            <div
              key={idx}
              className="bg-light dark:bg-coal-400 border border-success-light text-success rounded-lg px-3 py-2 text-xs font-medium shadow-sm flex flex-col md:flex-row md:items-center gap-1"
            >
    ...
    return (
      <p className="text-2sm text-gray-900 dark:text-gray-100 bg-success-light dark:bg-success-clarity p-4 rounded-lg border border-success-clarity">
  ...
  return (
    <div className="card bg-light dark:bg-coal-300 shadow-card border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
      <div className="px-7.5 py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-light dark:from-coal-400 dark:to-coal-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-1.5xl font-semibold text-gray-900 dark:text-gray-100">
                Historia Clínica #{numeroHistoria}
              </h3>
              {historia.historialCambios && historia.historialCambios.length > 0 && (
                <div className="text-2sm text-gray-600 dark:text-gray-400 mt-0.5">
      ...
      <div className="px-7.5 py-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div>
            <h4 className="text-2sm font-semibold text-gray-700 dark:text-gray-200 mb-2 flex items-center gap-2">
              <span className="w-1 h-4 bg-primary rounded-full"></span>
              Motivo de Consulta
            </h4>
            <p className="text-2sm text-gray-900 dark:text-gray-100 bg-light-active dark:bg-coal-400 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <div>
            ...
            <div className="text-2sm text-gray-900 dark:text-gray-100 bg-light-active dark:bg-coal-400 p-4 rounded-lg border border-gray-200 dark:border-gray-700 space-y-1">
          ...
          <div>
            <h4 className="text-2sm font-semibold text-gray-700 dark:text-gray-200 mb-3 flex items-center gap-2">
              <span className="w-1 h-4 bg-info rounded-full"></span>
              Diagnóstico
            ...
            <div className="bg-info-light dark:bg-info-clarity p-4 rounded-lg border border-info-clarity">
              {renderDiagnostico()}
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-success-light dark:bg-success-clarity p-4 rounded-lg border border-success-clarity">
              {renderTratamiento()}
            </div>
          </div>
          ...
          {historia.observaciones && (
            <div className="lg:col-span-2">
              ...
              <p className="text-2sm text-gray-900 dark:text-gray-100 bg-warning-light dark:bg-warning-clarity p-4 rounded-lg border border-warning-clarity">
                {historia.observaciones}
              </p>
            </div>
          )}
