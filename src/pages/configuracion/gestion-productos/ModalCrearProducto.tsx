...
import { ModalMarca } from '@/pages/registrar-compra/ModalMarca';
import { ModalTipoProducto } from '@/pages/registrar-compra/ModalTipoProducto';
import { ModalCategoria } from '@/pages/registrar-compra/ModalCategoria';
import { ModalMedida } from '@/pages/registrar-compra/ModalMedida';
