...
export const InfoBanner: React.FC = () => {
  return (
    <div className="bg-gradient-to-r from-info-light via-primary-light to-info-light rounded-xl p-5 border border-info-clarity">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-3xs text-gray-700 leading-relaxed">
