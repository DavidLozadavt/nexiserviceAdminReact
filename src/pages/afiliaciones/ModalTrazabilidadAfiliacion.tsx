  ...
  return (
    <Modal open={open} onClose={onClose}>
      <ModalContent className="max-w-[950px] top-[5%] p-4">
        <ModalHeader>
          <ModalTitle>Cambios de estado de la afiliación</ModalTitle>
        ...
        <ModalBody className="grid gap-3 px-0 py-2">
          ...
          <div>
            <div className="tabs mb-5 flex">
              ...
              >
                Trazabilidad de estados de la afiliación
              </button>
              <button
                className={`tab px-4 py-2 ${activeTab === 'tab2' ? 'active' : ''}`}
                onClick={() => handleTabChange('tab2')}
              >
                Grafico de trazabilidad de la afiliación
              </button>
            </div>
              ...
              {activeTab === 'tab1' && (
                <div id="tab_1" className="p-2">
                  {loading ? (
                    ...
                    <p className="text-gray-500">No hay observaciones disponibles.</p>
                  )}
                </div>
              )}
              {activeTab === 'tab2' && (
                <div id="tab_2" className="p-2">
                  <div className="card h-full">
                    <div className="card-header flex-wrap gap-2">
                      <h3 className="card-title">Grafico de Trazabilidad</h3>
                    </div>
