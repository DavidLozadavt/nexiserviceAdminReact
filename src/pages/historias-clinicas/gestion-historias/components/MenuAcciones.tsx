  ...
  return (
    <div className="relative">
      <button
        ...
        className="btn btn-sm bg-primary hover:bg-primary-active text-primary-inverse px-4 py-2 rounded-lg transition-all duration-200 text-2xs font-medium flex items-center"
      >
