...
const EvolucionClinicaForm: React.FC<EvolucionClinicaFormProps> = ({
  onAddEvolucion,
  responsable
}) => {
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-2sm text-gray-600">
              Responsable: <span className="font-medium text-gray-900">{responsable}</span>
            </p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 bg-gray-50">
              <SignatureCanvas
                ...
                canvasProps={{
                  className:
                    'w-full h-40 bg-white rounded-lg border border-gray-200 shadow-sm cursor-crosshair'
                }}
              />
                ...
                <div className="mt-4 p-3 bg-success-light border border-success-clarity rounded-lg">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      <p className="text-2sm font-medium text-success-active mb-2">
                        Firma guardada correctamente
                      </p>
                      <img
                        src={firmaDigital}
                        alt="Firma digital guardada"
                        className="max-h-20 bg-white p-2 rounded border border-gray-200"
                      />
                    </div>
                  </div>
                </div>
