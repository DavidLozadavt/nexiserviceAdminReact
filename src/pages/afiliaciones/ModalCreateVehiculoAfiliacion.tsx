...
const ModalCreateVehiculoAfiliacion = ({ open, onClose, afiliacion, onSave }: ModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`store_vehiculo_afiliacion/${afiliacion.id}`, data);
      enqueueSnackbar('Vehículo guardado exitosamente.', { variant: 'success' });
      reset();
      onSave();
      onClose();
    } catch (error) {
          ...
          <div className="flex justify-end gap-3 mt-4 px-4">
            <div>
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-2">
                  <div>
                    <label className="block text-sm font-medium mb-2">Numero de Pasajeros * </label>
                    <input
                      type="text"
                      name="numPuestos"
